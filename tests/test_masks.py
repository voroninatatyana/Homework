...
def valid_account_numbers() -> list[tuple[str, str]]:
    return [("12345678901234567890", "**7890"), ("73654108430135874305", "**4305"), ("00000000000000000001", "**0001")]


@pytest.fixture
def invalid_account_numbers() -> list[str]:
    return [("1234"), ("abcdefghijklmnop"), (None), ("")]  # Слишком короткий  # Не цифры  # None  # Пустая строка
...
@pytest.mark.parametrize(
    "card_number",
    ["1234", "1234567890", "abcdefghijklmnop", "", None],  # 4 цифры  # 10 цифр  # буквы  # пустая строка  # None
)
...
@pytest.mark.parametrize(
    ...
    [("12345678901234567890", "**7890"), ("73654108430135874305", "**4305"), ("00000000000000000001", "**0001")],
)
...
@pytest.mark.parametrize(
    "account_number",
    ["1234", "abcdefghijklmnop", "", None],  # 4 цифры (меньше минимальной длины)  # буквы  # пустая строка  # None
)
