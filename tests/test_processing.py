...
def sample_transactions():
    return [
        ...
        {"id": 5, "state": "EXECUTED", "date": "2023-01-15T12:00:00.000000"},  # Такая же дата, как у id=1
    ]
...
def edge_case_transactions():
    return [
        {"id": 6, "state": "EXECUTED", "date": "invalid_date_format"},  # Некорректный формат даты
        {"id": 7, "state": "FAILED", "date": None},  # Отсутствующая дата
    ]
...
@pytest.mark.parametrize(
    ...
    [("EXECUTED", 3), ("CANCELED", 1), ("PENDING", 1), ("COMPLETED", 0)],  # Несуществующий статус
)
