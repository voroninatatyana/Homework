...
### 10. Реализован декоратор  log: Декоратор может логировать работу функции и ее результат как в файл, так и в консоль.
#### log(filename=None)
## Установка
...
```
Покрытие тестами: код покрыт тестами более чем на 80%,отчет в формате HTML в указанной папке.
## Требования
Python 3.7+
## Лицензия
